...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->string('business_type')->nullable()->after('business_name'); // Event, Dining, Religious, Workshop, Travel, Attraction
            ...
            $table->json('bank_details')->nullable()->after('tax_id');
            ...
            $table->timestamp('last_login')->nullable()->after('vendor_rejection_reason');
        });
    }
