...
export default function TourismBooking({ booking, package: pkg }) {
    const { flash } = usePage().props;

    const handleCancel = () => {
        if (confirm("Cancel this booking and refund to wallet?")) {
            router.post(route("tourism.spiritual.booking.cancel", booking.id));
        }
    };
            ...
            <div className="max-w-xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                    ...
                    <div className="p-6">
                        ...
                        <h2 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">{pkg.name}</h2>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                            ...
                            {booking.travel_date && (
                                <div>
                                    ...
                                    <p className="font-medium text-gray-900 dark:text-gray-100">{booking.travel_date}</p>
                                </div>
                            )}
                            <div>
                        ...
                        <div className="flex gap-3 mt-6">
                            <Link
                                href={route("tourism.spiritual.index")}
