...
export default function CreateExperience({ categories, bookingModes }) {
    ...
    const isFormComplete = () => {
        ...
        const hasImage = preview || data.image;
        ...
        return hasBasicInfo && hasDescription && hasImage && hasBookingMode && hasBookingFields && hasCapacity;
    };
        ...
        <VendorAppLayout>
            ...
            <div className="space-y-5 pb-4">
                ...
                <div className="flex flex-col gap-4 pt-1">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-brand-primary leading-tight">Create New Experience</h1>
                        ...
                        <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-brand-border rounded-xl cursor-pointer hover:border-brand-primary/40 hover:bg-brand-primary/5 transition-all group">
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-xs text-brand-secondary mt-0.5">PNG, JPG up to 2MB</p>
                                </div>
                            </div>
                            <input
                                type="file"
