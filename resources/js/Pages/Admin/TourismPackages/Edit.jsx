...
export default function TourismPackageEdit({ package: pkg }) {
    ...
    const [preview, setPreview] = useState(pkg.image ? `/banner/${pkg.image}` : null);
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route("admin.tourism-packages.update", pkg.id), formData);
    };
