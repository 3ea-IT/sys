...
export default function AssistanceIndex({
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route("admin.assistance.index"), {
            search,
            status,
        });
    };
    ...
    const handleDelete = (id) => {
        if (confirm("Are you sure you want to delete this assistance?")) {
            router.delete(route("admin.assistance.destroy", id));
        }
    };

    const handleToggleStatus = (id) => {
        router.post(route("admin.assistance.toggle-status", id));
    };
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-brand-secondary dark:text-gray-400">
                        Manage all assistance services for temples
                    </p>
                </div>
                ...
                <div className="mb-6 flex justify-end">
                    <Link
                        href={route("admin.assistance.create")}
                ...
                {assistances &&
                    assistances.links &&
                    assistances.links.length > 3 && (
                        <div className="mt-6 flex justify-center gap-2">
                            {assistances.links.map((link, index) => (
                                <Link
                                    key={index}
                                    href={link.url || "#"}
