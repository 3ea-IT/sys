...
export default function AssistanceEdit({ assistance, temples, types }) {
    const [form, setForm] = useState({
        temple_id: assistance.temple_id,
        name: assistance.name,
        type: assistance.type,
        description: assistance.description || "",
        price: assistance.price,
        availability: assistance.availability || "",
        status: assistance.status,
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        router.put(route("admin.assistance.update", assistance.id), form);
    };
        ...
        <AdminAppLayout>
            <div className="max-w-4xl mx-auto">
                ...
                <h1 className="text-3xl font-bold text-brand-primary dark:text-gray-100 mb-8">
                    Edit Assistance: {assistance.name}
                </h1>
                <form
