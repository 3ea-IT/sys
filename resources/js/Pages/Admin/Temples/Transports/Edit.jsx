...
export default function TransportEdit({ transport, temples, types }) {
    const [form, setForm] = useState({
        temple_id: transport.temple_id,
        name: transport.name,
        type: transport.type,
    ...
    const [preview, setPreview] = useState(
        transport.image ? `/banner/${transport.image}` : null,
    );
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route("admin.transports.update", transport.id), formData);
    };
