...
export default function FestivalShowShow({ festivalShow }) {
    return (
        <AdminAppLayout>
            <div className="max-w-4xl mx-auto">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <Link
                        href={route("admin.festival-shows.index")}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <span
                                className={`px-3 py-1 rounded text-sm font-medium ${festivalShow.status === "active" ? "bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200" : "bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200"}`}
                            >
                                {festivalShow.status === "active"
                                    ? "Active"
                                    : "Inactive"}
                            </span>
                        </div>
                    </div>
                    {festivalShow.description && (
                        <div className="mb-6">
                            <label className="block text-sm font-medium text-brand-secondary dark:text-gray-400 mb-2">
                                Description
                            </label>
