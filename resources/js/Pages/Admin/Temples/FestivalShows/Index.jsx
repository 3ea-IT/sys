...
export default function FestivalShowIndex({
    festivalShows,
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route("admin.festival-shows.index"), {
            search,
            status,
        });
    };
    ...
    const handleDelete = (id) => {
        if (confirm("Are you sure you want to delete this festival show?")) {
            router.delete(route("admin.festival-shows.destroy", id));
        }
    };

    const handleToggleStatus = (id) => {
        router.post(route("admin.festival-shows.toggle-status", id));
    };
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-brand-primary dark:text-gray-100 mb-2">
                        Festival Shows Management
                    </h1>
                    <p className="text-brand-secondary dark:text-gray-400">
                        Manage all festival shows for temples
                    </p>
                </div>
                ...
                <div className="mb-6 flex justify-end">
                    <Link
                        href={route("admin.festival-shows.create")}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="Search festival shows..."
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                    <table className="w-full">
                        ...
                        <tbody className="divide-y divide-brand-border dark:divide-gray-700">
                            {festivalShows &&
                            festivalShows.data &&
                            festivalShows.data.length > 0 ? (
                                festivalShows.data.map((show) => (
                                    <tr
                                        key={show.id}
                ...
                {festivalShows &&
                    festivalShows.links &&
                    festivalShows.links.length > 3 && (
                        <div className="mt-6 flex justify-center gap-2">
                            {festivalShows.links.map((link, index) => (
                                <Link
                                    key={index}
                                    href={link.url || "#"}
