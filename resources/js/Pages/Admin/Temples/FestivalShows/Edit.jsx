...
export default function FestivalShowEdit({ festivalShow, temples }) {
    const [form, setForm] = useState({
        temple_id: festivalShow.temple_id,
        name: festivalShow.name,
        description: festivalShow.description || "",
        date: festivalShow.date,
        time: festivalShow.time,
        price: festivalShow.price,
        capacity: festivalShow.capacity,
        status: festivalShow.status,
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        router.put(route("admin.festival-shows.update", festivalShow.id), form);
    };
