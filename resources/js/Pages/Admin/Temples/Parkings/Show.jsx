...
export default function ParkingShow({ parking }) {
    return (
        <AdminAppLayout>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <span
                                className={`px-3 py-1 rounded text-sm font-medium ${parking.status === "active" ? "bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200" : "bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200"}`}
                            >
                    ...
                    <div className="flex gap-3 mt-8">
                        <Link
                            href={route("admin.parkings.edit", parking.id)}
