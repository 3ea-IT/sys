...
export default function ParkingEdit({ parking, temples }) {
    const [form, setForm] = useState({
        temple_id: parking.temple_id,
        name: parking.name,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        router.put(route("admin.parkings.update", parking.id), form);
    };
