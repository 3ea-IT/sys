...
export default function ParkingIndex({
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route("admin.parkings.index"), {
            search,
            status,
        });
    };
    ...
    const handleDelete = (id) => {
        if (confirm("Are you sure you want to delete this parking?")) {
            router.delete(route("admin.parkings.destroy", id));
        }
    };

    const handleToggleStatus = (id) => {
        router.post(route("admin.parkings.toggle-status", id));
    };
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-brand-secondary dark:text-gray-400">
                        Manage all parking facilities for temples
                    </p>
                </div>
                ...
                {/* Pagination */}
                {parkings && parkings.links && parkings.links.length > 3 && (
