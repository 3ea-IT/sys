...
export default function GuideIndex({
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route("admin.guides.index"), {
            search,
            status,
        });
    };
    ...
    const handleDelete = (id) => {
        if (confirm("Are you sure you want to delete this guide?")) {
            router.delete(route("admin.guides.destroy", id));
        }
    };

    const handleToggleStatus = (id) => {
        router.post(route("admin.guides.toggle-status", id));
    };
    ...
    return (
        <AdminAppLayout>
            <div className="max-w-7xl mx-auto">
                ...
                {/* Pagination */}
                {guides && guides.links && guides.links.length > 3 && (
