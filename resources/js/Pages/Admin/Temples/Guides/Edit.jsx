...
export default function GuideEdit({ guide, temples, languages }) {
    const [form, setForm] = useState({
        temple_id: guide.temple_id,
        name: guide.name,
    ...
    const [preview, setPreview] = useState(
        guide.image ? `/banner/${guide.image}` : null,
    );
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route("admin.guides.update", guide.id), formData);
    };
