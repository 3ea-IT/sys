...
export default function VipIndex({
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        router.get(route("admin.vips.index"), {
            search,
            status,
        });
    };
    ...
    const handleDelete = (id) => {
        if (confirm("Are you sure you want to delete this VIP package?")) {
            router.delete(route("admin.vips.destroy", id));
        }
    };

    const handleToggleStatus = (id) => {
        router.post(route("admin.vips.toggle-status", id));
    };
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-brand-secondary dark:text-gray-400">
                        Manage all VIP packages for temples
                    </p>
                </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="Search VIP packages..."
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                    <table className="w-full">
                        ...
                        <tbody className="divide-y divide-brand-border dark:divide-gray-700">
                            {vips && vips.data && vips.data.length > 0 ? (
                                vips.data.map((vip) => (
                                    <tr
                                        key={vip.id}
                ...
                {/* Pagination */}
                {vips && vips.links && vips.links.length > 3 && (
                    <div className="mt-6 flex justify-center gap-2">
                        {vips.links.map((link, index) => (
                            <Link
                                key={index}
                                href={link.url || "#"}
